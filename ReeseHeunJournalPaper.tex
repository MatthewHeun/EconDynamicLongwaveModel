...
\noindent **** Caleb: should that be $\tilde{c}_\mathrm{t}$ in the numerator of Equation~\ref{eq:z}? **** which is an indicator of the mortality rate through Equation~\ref{eq:mortality_rate}.
