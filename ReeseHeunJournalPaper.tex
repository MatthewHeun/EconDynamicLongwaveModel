...
\noindent with $Y$ representing economic output (in \$/year) **** Are these 2005 dollars? Be sure to identify the years of the dollars whereever dollars appear in a unit. ****, $A$ representing the stock of knowledge and ideas (in ideas), $L_\mathrm{Y}$ representing labor in the production sector (in workers/year), and $T$ representing the stock of available land (in m$^2$).
