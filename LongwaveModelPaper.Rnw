...
# Load raw data
rawData <- read.table(file="data/USData.txt", header = TRUE)
@
...
The following table shows the raw data for the U.S.
...
print(rawDataXtable, caption.placement="top", sanitize.rownames.function = identity)
@
